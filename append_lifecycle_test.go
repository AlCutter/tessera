...
const (
	testWit1VKey = "Wit1+70a724e2+BEAmpOwR6YzVG1/iW8gLLb2llzR6Lw7Wn9woTl7iVSDV"
	testWit1SKey = "PRIVATE+KEY+Wit1+461396f6+AZKU/TRmoNVB5uqpeR11A1pplvXuMlpjT8Y0uafQfW7c"
	testWit2VKey = "Wit2+049a9a27+BFBgW0fxu7qLpjSj/TBuwTnc7g0d7HBjAvGDZFnhar/l"
	testWit2SKey = "PRIVATE+KEY+Wit2+dc534d54+AVCy4QZOyRs8M9nzBRDVOxWZ248vqAPw42ecTm/auXtt"
	testWit3VKey = "Wit3+308e36fe+BP205OA5Q93UgZxIFT6+GlsBzUwCdp/yXEV/GS1QGsOw"
	testWit3SKey = "PRIVATE+KEY+Wit3+3f9bf972+AdRCWGkPVXTV38Z2jVwRZhCpG+fTWUIiAKZmvmFMmSBP"

	testMirrorVKey = "Mirror1+05819857+BJ2ygyYQjigWoFZHxkY6H3v7RH5m0Z0WgL5d5kr2VzY3"
	testMirrorSKey = "PRIVATE+KEY+Mirror1+cd660884+AVCiclSgngLIITPcN01QBEKuD6JgsjhjvpvoKKfwNzft"
)
